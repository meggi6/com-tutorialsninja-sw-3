...
public class MyAccountsTest extends Utility {
    ...
    public void verifyThatUserRegisterAccountSuccessfully() {
        ...
        sendTextToElement(By.id("input-firstname"), "megha");

        //3.4 Enter Last Name
        sendTextToElement(By.id("input-lastname"), "vij");

        //3.5 Enter Email
        sendTextToElement(By.id("input-email"), "megha123@grr.la");

        //3.6 Enter Telephone
        sendTextToElement(By.id("input-telephone"), "02053412578");

        //3.7 Enter Password
        sendTextToElement(By.id("input-password"), "megha123@5");

        //3.8 Enter Password Confirm
        sendTextToElement(By.id("input-confirm"), "Megha123@5");
    ...
    public void verifyThatUserShouldLoginAndLogoutSuccessfully() {
        ...
        sendTextToElement(By.id("input-email"), "ajay123@gmail.com");
        //4.5 Enter Password
        sendTextToElement(By.id("input-password"), "Ajay@1234");
