...
public class LaptopsAndNotebooksTest extends Utility {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.xpath("//input[@id='input-payment-firstname']"), "Megha");
        sendTextToElement(By.xpath("//input[@id='input-payment-lastname']"), "vij");
        sendTextToElement(By.xpath("//input[@id='input-payment-email']"), "megha123@gmail.com");
        sendTextToElement(By.xpath("//input[@id='input-payment-telephone']"), "07879867678");
        sendTextToElement(By.xpath("//input[@id='input-payment-address-1']"), "17 lewes road");
        sendTextToElement(By.xpath("//input[@id='input-payment-city']"), "London");
        sendTextToElement(By.xpath("//input[@id='input-payment-postcode']"), "N12 9nh");
